...
if __name__ == '__main__':
    ...
    parser.add_argument('--name-images-folder', type=str, help="name of processed images")
    parser.add_argument('--name-labels-folder', type=str, help="name of processed labels")
